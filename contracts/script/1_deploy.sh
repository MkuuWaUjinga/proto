...
cast rpc anvil_setBalance $ADDRESS_USER 1000000000000000000 --rpc-url http://localhost:8545
cast rpc anvil_setBalance $ADDRESS_STRATEGIST 1000000000000000000 --rpc-url http://localhost:8545
cast rpc anvil_setBalance $ADDRESS_RUNNER 1000000000000000000 --rpc-url http://localhost:8545
...
npx slot20 balanceOf 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599 --rpc http://localhost:8545
# mint wbtc for the user
cast rpc anvil_setStorageAt $addressBTC 0xcfb4641a0019e1aaa4f2b6abbc9bb05268b397026332b56536496c28fa138aee 0x000000000000000000000000000000000000000000000000000000174876e800 --rpc-url http://localhost:8545 
...
cast call $addressBTC "balanceOf(address)(uint256)" $ADDRESS_USER --rpc-url http://localhost:8545 
