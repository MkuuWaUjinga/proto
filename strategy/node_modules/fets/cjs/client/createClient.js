            ...
            return new Proxy({}, {
                get(_target, method) {
                    return async function (requestParams = {}) {
                        var _a, _b;
                        for (const pathParamKey in (requestParams === null || requestParams === void 0 ? void 0 : requestParams.params) || {}) {
                            const value = (_a = requestParams === null || requestParams === void 0 ? void 0 : requestParams.params) === null || _a === void 0 ? void 0 : _a[pathParamKey];
                            if (value) {
                        ...
                        let searchParams;
                        if (requestParams === null || requestParams === void 0 ? void 0 : requestParams.query) {
                            searchParams = new fetch_1.URLSearchParams();
                            for (const queryParamKey in (requestParams === null || requestParams === void 0 ? void 0 : requestParams.query) || {}) {
                                const value = (_b = requestParams === null || requestParams === void 0 ? void 0 : requestParams.query) === null || _b === void 0 ? void 0 : _b[queryParamKey];
                                if (value) {
                        ...
                        const requestInit = {
                            method,
                            headers: (requestParams === null || requestParams === void 0 ? void 0 : requestParams.headers) || {},
                        };
                        if (requestParams === null || requestParams === void 0 ? void 0 : requestParams.json) {
                            requestInit.body = JSON.stringify(requestParams.json);
                            requestInit.headers['Content-Type'] = 'application/json';
                        }
                        if (requestParams === null || requestParams === void 0 ? void 0 : requestParams.formData) {
                        ...
                        response || (response = await currentFetchFn(finalUrl, requestInit));
