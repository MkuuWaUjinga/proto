...
function useAjv({ components = {}, } = {}) {
    ...
    return {
        onRoute({ schemas, handlers }) {
            ...
            if (((_a = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _a === void 0 ? void 0 : _a.headers) && !(0, types_js_1.isZodSchema)(schemas.request.headers)) {
            ...
            if (((_b = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _b === void 0 ? void 0 : _b.params) && !(0, types_js_1.isZodSchema)(schemas.request.params)) {
                const validateFn = ajv.compile({
            ...
            if (((_c = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _c === void 0 ? void 0 : _c.query) && !(0, types_js_1.isZodSchema)(schemas.request.query)) {
                const validateFn = ajv.compile({
            ...
            if (((_d = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _d === void 0 ? void 0 : _d.json) && !(0, types_js_1.isZodSchema)(schemas.request.json)) {
                const validateFn = ajv.compile({
            ...
            if (((_e = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _e === void 0 ? void 0 : _e.formData) && !(0, types_js_1.isZodSchema)(schemas.request.formData)) {
                const validateFn = ajv.compile({
                ...
                validationMiddlewares.set('formData', async (request) => {
                    ...
                    if ((contentType === null || contentType === void 0 ? void 0 : contentType.includes('multipart/form-data')) ||
                        (contentType === null || contentType === void 0 ? void 0 : contentType.includes('application/x-www-form-urlencoded'))) {
            ...
            if (fast_json_stringify_1.default && (schemas === null || schemas === void 0 ? void 0 : schemas.responses)) {
        ...
        onSerializeResponse({ serverContext, lazyResponse }) {
            ...
            if (serializers) {
                const serializer = serializers.get(((_a = lazyResponse.init) === null || _a === void 0 ? void 0 : _a.status) || 200);
                if (serializer) {
