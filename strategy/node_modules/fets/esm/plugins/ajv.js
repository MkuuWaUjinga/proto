...
export function useAjv({ components = {}, } = {}) {
    ...
    return {
        onRoute({ schemas, handlers }) {
            ...
            if (((_a = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _a === void 0 ? void 0 : _a.headers) && !isZodSchema(schemas.request.headers)) {
            ...
            if (((_b = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _b === void 0 ? void 0 : _b.params) && !isZodSchema(schemas.request.params)) {
                const validateFn = ajv.compile({
            ...
            if (((_c = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _c === void 0 ? void 0 : _c.query) && !isZodSchema(schemas.request.query)) {
                const validateFn = ajv.compile({
            ...
            if (((_d = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _d === void 0 ? void 0 : _d.json) && !isZodSchema(schemas.request.json)) {
                const validateFn = ajv.compile({
            ...
            if (((_e = schemas === null || schemas === void 0 ? void 0 : schemas.request) === null || _e === void 0 ? void 0 : _e.formData) && !isZodSchema(schemas.request.formData)) {
                const validateFn = ajv.compile({
