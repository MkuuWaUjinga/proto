                        ...
                        if (selectionNode.kind === graphql_1.Kind.FIELD &&
                            ...
                            if (firstArg != null) {
                                ...
                                if (firstArg.value.kind === graphql_1.Kind.INT) {
                                    ...
                                    (_d = executionRequest.variables) === null || _d === void 0 ? true : delete _d[firstArg.value.name.value];
                                }
                                if (numberOfTotalRecords != null && numberOfTotalRecords > this.config.limitOfRecords) {
                                    const fieldName = selectionNode.name.value;
                                    const aliasName = ((_e = selectionNode.alias) === null || _e === void 0 ? void 0 : _e.value) || fieldName;
                                    let initialSkip = 0;
                                    if (((_f = skipArg === null || skipArg === void 0 ? void 0 : skipArg.value) === null || _f === void 0 ? void 0 : _f.kind) === graphql_1.Kind.INT) {
                                        initialSkip = parseInt(skipArg.value.value);
                                    }
                                    else if (((_g = skipArg === null || skipArg === void 0 ? void 0 : skipArg.value) === null || _g === void 0 ? void 0 : _g.kind) === graphql_1.Kind.VARIABLE) {
                                        initialSkip = (_h = executionRequest.variables) === null || _h === void 0 ? void 0 : _h[skipArg.value.name.value];
                                        (_j = executionRequest.variables) === null || _j === void 0 ? true : delete _j[skipArg.value.name.value];
                                    }
                                    let skip;
